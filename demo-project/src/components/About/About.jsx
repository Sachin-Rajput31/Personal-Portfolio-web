...
export default function About() {
  return (
      <div className="py-16 bg-gradient-to-r from-blue-100 to-transparent">
          <div className="container m-auto px-6 text-gray-700 md:px-12 xl:px-6">
              <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
                  ...
                  <div className="md:7/12 lg:w-6/12">
                      <h2 className="text-2xl text-gray-900 font-bold md:text-4xl shadow-xl hover:scale-y-50 shadow-gray-100 ">
                          Welcome friends, seekers to my website !!
                      </h2>
                      <br/>
                      <p className="mt-6 text-gray-600 shadow-lg shadow-green-100 hover:underline underline-offset-4">
                      ...
                      <br/>
                      <p className="mt-4 text-gray-600 shadow-md shadow-inner font-extrabold shadow-blue-100 shadow-red-200">
